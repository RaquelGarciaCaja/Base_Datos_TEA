...
CREATE TABLE `100_TIPO_DE_PROFESIONALES` (
	...
	100_fechaNacimiento DATE NOT NULL,	
	100_nomFichero CHAR( 100 ) NOT NULL,
	100_sueldoBrutoAnual FLOAT( 8, 2 ) UNSIGNED NOT NULL ,
	100_sexo BOOLEAN NOT NULL

)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


CREATE TABLE `200_PERSONAS_CON_TEA`(
	200_idPersonaTea SMALLINT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
	200_nombre CHAR (25) NOT NULL,
	200_apellido CHAR (50) NOT NULL,
	200_fechaNacimiento DATE NOT NULL,
	200_nomFichero CHAR( 100 ) NOT NULL,
	200_sexo BOOLEAN NOT NULL
...
CREATE TABLE `110_ACTIVIDADES_PROFESIONALES`(
...
CONSTRAINT `kf110_100_idProfesional` FOREIGN KEY (100_idProfesional) REFERENCES 100_TIPO_DE_PROFESIONALES (100_idProfesional),
CONSTRAINT `kf110_500_idActividad` FOREIGN KEY (500_idActividad) REFERENCES 500_ACTIVIDADES (500_idActividad)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;



CREATE TABLE `210_ACTIVIDADES_TEA`(
500_idActividad SMALLINT UNSIGNED NOT NULL,
200_idPersonaTea SMALLINT UNSIGNED NOT NULL,

PRIMARY KEY (200_idPersonaTea, 500_idActividad),
CONSTRAINT `kf210_200_idPersonaTea` FOREIGN KEY (200_idPersonaTea) REFERENCES 200_PERSONAS_CON_TEA (200_idPersonaTea),
CONSTRAINT `kf210_500_idActividad` FOREIGN KEY (500_idActividad) REFERENCES 500_ACTIVIDADES (500_idActividad)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


CREATE TABLE `410_TEA_PROBLEMAS`(
400_idProblema TINYINT UNSIGNED NOT NULL,
200_idPersonaTea SMALLINT UNSIGNED NOT NULL,
410_fechaInicioProblema DATE NOT NULL,

PRIMARY KEY (400_idProblema, 200_idPersonaTea),
CONSTRAINT `kf410_200_idPersonaTea` FOREIGN KEY (200_idPersonaTea) REFERENCES 200_PERSONAS_CON_TEA (200_idPersonaTea),
...
CREATE TABLE `211_ACTIVIDADES_TEA_PROFESIONALES`(
100_idProfesional TINYINT UNSIGNED NOT NULL,
500_idActividad SMALLINT UNSIGNED NOT NULL,
200_idPersonaTea SMALLINT  UNSIGNED NOT NULL,
211_fechaHoraRealizacion DATETIME NOT NULL,
211_descripcion TEXT NOT NULL,
211_gradoSatisfaccion TINYINT UNSIGNED NOT NULL,

PRIMARY KEY (100_idProfesional, 200_idPersonaTea, 500_idActividad),
CONSTRAINT `kf211_100_idProfesional_500_idActividad` FOREIGN KEY (100_idProfesional, 500_idActividad) REFERENCES 110_ACTIVIDADES_PROFESIONALES (100_idProfesional, 500_idActividad),
CONSTRAINT `kf211_500_idActividad_200_idPersonaTea` FOREIGN KEY (500_idActividad, 200_idPersonaTea) REFERENCES 210_ACTIVIDADES_TEA (500_idActividad, 200_idPersonaTea)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;



CREATE TABLE `411_TEA_PROBLEMAS_GRADO`(
400_idProblema TINYINT UNSIGNED NOT NULL,
200_idPersonaTea SMALLINT UNSIGNED NOT NULL,
411_fechaReevaluacion DATE NOT NULL,
300_idGrado TINYINT UNSIGNED NOT NULL,

PRIMARY KEY (400_idProblema, 200_idPersonaTea),
CONSTRAINT `kf411_400_idProblema_200_idPersonaTea` FOREIGN KEY (400_idProblema, 200_idPersonaTea) REFERENCES 410_TEA_PROBLEMAS (400_idProblema, 200_idPersonaTea),
